...
local ModelPath = "models/mad_antmob.mdl"
...
hook.Add("PostDrawOpaqueRenderables", "DrawSoloLevelingNPCHealthBarAnt", function()
    for _, ent in ipairs(ents.FindByClass("mad_ant_mob")) do
        if IsValid(ent) then
            DrawHealthBar(ent)
        end
    end
