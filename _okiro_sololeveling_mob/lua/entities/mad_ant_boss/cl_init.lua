...
local ModelPath = "models/mad_antboss.mdl"
...
hook.Add("PostDrawOpaqueRenderables", "DrawSoloLevelingNPCHealthBarAntBoss", function()
    for _, ent in ipairs(ents.FindByClass("mad_ant_boss")) do
        if IsValid(ent) then
            DrawHealthBar(ent)
        end
    end
