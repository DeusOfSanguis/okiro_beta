...
local ModelPath = "models/mad_goblin.mdl"
...
hook.Add("PostDrawOpaqueRenderables", "DrawSoloLevelingNPCHealthBar", function()
    for _, ent in ipairs(ents.FindByClass("mad_goblin_mob")) do
        if IsValid(ent) then
            DrawHealthBar(ent)
        end
    end
