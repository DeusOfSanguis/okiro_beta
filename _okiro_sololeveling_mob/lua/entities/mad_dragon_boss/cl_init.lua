...
local ModelPath = "models/mad_dragonboss.mdl"
...
function ENT:Initialize()
    ...
    if IsValid(self.ClientModel) then
        ...
        self.ClientModel:SetModelScale(2)
...
hook.Add("PostDrawOpaqueRenderables", "DrawSoloLevelingNPCHealthBarDragon", function()
    for _, ent in ipairs(ents.FindByClass("mad_dragon_boss")) do
        if IsValid(ent) then
            DrawHealthBar(ent)
        end
    end
