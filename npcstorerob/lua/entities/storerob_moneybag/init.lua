...
function ENT:AcceptInput(name, activator, caller)
	...
	net.Start( "ncprobmsg" )
		net.WriteString( string.format( "You collected $"..(isfunction(NPCRobSystem.Config.RobAmount) and NPCRobSystem.Config.RobAmount() or NPCRobSystem.Config.RobAmount).." from the moneybag!" ) )
	net.Send(activator)
