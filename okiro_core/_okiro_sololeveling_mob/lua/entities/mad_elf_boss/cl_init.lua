...
local ModelPath = "models/mad_elfboss.mdl"
...
hook.Add("PostDrawOpaqueRenderables", "DrawSoloLevelingNPCHealthBarElfBoss", function()
    for _, ent in ipairs(ents.FindByClass("mad_elf_boss")) do
        if IsValid(ent) then
            DrawHealthBar(ent)
        end
    end
