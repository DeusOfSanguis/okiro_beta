...
local ModelPath = "models/mad_loupevo.mdl"
...
hook.Add("PostDrawOpaqueRenderables", "DrawSoloLevelingNPCHealthBarLoup2", function()
    for _, ent in ipairs(ents.FindByClass("mad_loup2_mob")) do
        if IsValid(ent) then
            DrawHealthBar(ent)
        end
    end
