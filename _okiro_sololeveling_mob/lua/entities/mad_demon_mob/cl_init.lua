...
local ModelPath = "models/mad_demonmob.mdl"
...
hook.Add("PostDrawOpaqueRenderables", "DrawSoloLevelingNPCHealthBarDemon", function()
    for _, ent in ipairs(ents.FindByClass("mad_demon_mob")) do
        if IsValid(ent) then
            DrawHealthBar(ent)
        end
    end
