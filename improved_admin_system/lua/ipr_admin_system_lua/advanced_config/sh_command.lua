...
Admin_System_Global.Ticket_Cmd = "!ticket" --- // Panel pour générer un ticket, inclure votre commande ici (ne pas inclure ///, celui-ci est déjà inclu automatiquement via la variable "Admin_System_Global.OverrideOpenTick" dans le fichier de configuration general).
...
Admin_System_Global.Stats_Cmd = "admin_verification" --- // Panel des statistiques de vos tickets (logs).
