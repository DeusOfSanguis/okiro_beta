...
function Admin_System_Global:cmds_tbl()
    return ipr_cmds_add
end

for cmd, tbl in pairs(ipr_cmds_add) do
    if not Admin_System_Global.TicketLoad and (cmd == Admin_System_Global.Ticket_Cmd) then
      continue
    end

    concommand.Add(cmd, tbl.func)
end