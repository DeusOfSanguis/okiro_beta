...
local ModelPath = "models/mad_lezardboss.mdl"
...
hook.Add("PostDrawOpaqueRenderables", "DrawSoloLevelingNPCHealthBarLezardBoss", function()
    for _, ent in ipairs(ents.FindByClass("mad_lezard_boss")) do
        if IsValid(ent) then
            DrawHealthBar(ent)
        end
    end
