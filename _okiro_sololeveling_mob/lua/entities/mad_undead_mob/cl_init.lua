...
local ModelPath = "models/mad_undeadmob.mdl"
...
hook.Add("PostDrawOpaqueRenderables", "DrawSoloLevelingNPCHealthBarUndead", function()
    for _, ent in ipairs(ents.FindByClass("mad_undead_mob")) do
        if IsValid(ent) then
            DrawHealthBar(ent)
        end
    end
