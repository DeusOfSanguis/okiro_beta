...
--- > [Ticket Notification]
Admin_System_Global.Ticket_Text = "Le ticket a bien été envoyé, temps de réponse estimé max : 10 minutes !" --- Le texte a afficher lorsqu'un joueur a envoyé un ticket aux administrateurs.
