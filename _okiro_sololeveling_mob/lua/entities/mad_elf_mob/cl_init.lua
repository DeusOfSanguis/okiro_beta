...
local ModelPath = "models/mad_elfmob.mdl"
...
function ENT:Initialize()
    ...
    if IsValid(self.ClientModel) then
        ...
        self.ClientModel:SetModelScale(1.4)
...
hook.Add("PostDrawOpaqueRenderables", "DrawSoloLevelingNPCHealthBarElf", function()
    for _, ent in ipairs(ents.FindByClass("mad_elf_mob")) do
        if IsValid(ent) then
            DrawHealthBar(ent)
        end
    end
