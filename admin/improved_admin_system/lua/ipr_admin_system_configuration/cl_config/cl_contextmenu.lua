...
Admin_System_Global.Cacher_ContextDefaut = false --- Cacher les buttons du Context Menu par défaut de Garry's Mod (Affichage, PNJs, BodyGroup ect..)
...
Admin_System_Global.Title = "Okiro Admin - Context Menu" --- Titre du context menu de gauche.
...
Admin_System_Global.ContextLeftHide = true --- true : Cacher le context menu de gauche.
...
Admin_System_Global.ContextRightHide = true --- true : Cacher le context menu de droite.
Admin_System_Global.ContextRightPos = "gauche" --- (gauche,droite) Position du context menu de droite.
