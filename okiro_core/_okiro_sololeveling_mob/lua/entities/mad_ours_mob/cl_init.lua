...
local ModelPath = "models/mad_oursmob.mdl"
...
hook.Add("PostDrawOpaqueRenderables", "DrawSoloLevelingNPCHealthBarOurs", function()
    for _, ent in ipairs(ents.FindByClass("mad_ours_mob")) do
        if IsValid(ent) then
            DrawHealthBar(ent)
        end
    end
